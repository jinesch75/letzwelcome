  ...
  return (
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 mb-8">
        ...
        <div className="flex items-start gap-3 py-2">
          <input
            ...
            onChange={handleChange}
            disabled={loading}
            className="mt-1.5 w-4 h-4 rounded accent-lw-blue-deep cursor-pointer"
          />
          <label
            htmlFor="gdprConsent"
            className="text-sm text-lw-charcoal leading-relaxed cursor-pointer"
          >
            I agree to the{' '}
            <Link href="/privacy" className="text-lw-blue-deep hover:text-lw-blue-light font-medium transition-colors">
              Privacy Policy
            </Link>{' '}
            and{' '}
            <Link href="/terms" className="text-lw-blue-deep hover:text-lw-blue-light font-medium transition-colors">
              Terms of Service
            </Link>
          </label>
        </div>
        {errors.gdprConsent && (
          <p className="text-sm text-lw-red font-medium">{errors.gdprConsent}</p>
        )}
      ...
      <p className="text-center text-lw-charcoal">
        {t('hasAccount')}{' '}
        <Link href="/login" className="text-lw-blue-deep hover:text-lw-blue-light font-medium transition-colors">
          {t('signIn')}
        </Link>
      </p>
    </div>
